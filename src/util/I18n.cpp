...
const QHash<QByteArray, QString>& zh() {
    static const QHash<QByteArray, QString> m = {
        ...
        {"Copyright",       QStringLiteral("版权")},
        {"View on GitHub",  QStringLiteral("在 GitHub 上查看")},
